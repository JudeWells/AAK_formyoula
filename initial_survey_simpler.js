...
function generate_report(grit_score){
 ...
 your grit include finding hobbies and interests that you care about and enjoy.'
    ...
    report += '\nRemember that grit is something you\
...
function make_wellbeing_report(wemwbs_score){
  ...
  if (wemwbs_score >= 28.13){ //score is in the top 25%
    report += 'Your self-reported wellbeing score is higher than 75% of people. We are mostly \
    interested in seeing how your wellbeing changes with time rather than comparing you\
    with other people. If you want to talk to\
  ...
  //score is above the median
    ...
    report += 'Your self-reported wellbeing is higher than most people. We are mostly \
    interested in seeing how your wellbeing changes with time rather than comparing you\
    with other people. If you want to talk to\
    Art Against Knives staff about your wellbeing, mental health or any other reason just let one of us know.''
  }
 ...
 that\'s ok wellbeing is something that changes with time. Sometimes your wellbeing \
 score can change daily based on your mood or what happened on that day. We are mostly \
 interested in seeing how your wellbeing changes with time rather than comparing you\
 with other people. If you want to talk to\
 Art Against Knives staff about your wellbeing, mental health or any other reason just let one of us know.''
  }
  //score is in the lower quartile
    ...
    report += 'Wellbeing is something that changes with time. Sometimes your wellbeing \
 score can change daily based on your mood or what happened on that day. \
 If you want to talk to Art Against Knives staff about your wellbeing, mental health or \
 any other reason just let one of us know.'
  }
  return report
}
